...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { dosageform: @drug.dosageform, propname: @drug.propname, typename: @drug.typename }
    end
  ...
  test "should update drug" do
    patch :update, id: @drug, drug: { dosageform: @drug.dosageform, propname: @drug.propname, typename: @drug.typename }
    assert_redirected_to drug_path(assigns(:drug))
  end
